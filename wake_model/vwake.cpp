...
double velocity_fieldx_c(double * in_array,int size){
    ...
    */
    ...
    int allocationsize=100000; // maximum only affects memory useage, but too little will fail
...
double velocity_fieldy_c(double * in_array,int size){
  ...
  int imethod = 6; // 61 pt
  */
  int allocationsize=100000; // maximum only affects memory useage, but to little will fail
