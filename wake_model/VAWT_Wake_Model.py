...
def coef_val():
    ...
    return coef0,coef1,coef2,coef3,coef4,coef5,coef6,coef7,coef8,coef9
...
def velocity_field(xt,yt,x0,y0,velf,dia,rot,chord,B,param=None,veltype='all',integration='simp',m=220,n=200):
    ...
    ###################################
            ...
            if veltype == 'all' or veltype == 'x' or veltype == 'ind':
                ...
                # vel_x = dblquad(_vawtwake.integrandx,0.,xbound,lambda x: -4.*dia,lambda x: 4.*dia,args=argval)
