...
subroutine OASPL(n,p,ox,oy,oz,B,Hub,high,rad,c,c1,alpha,nu,c0,psi,AR,&
  ...
  ! f = (/10.0_dp,12.5_dp,16.0_dp,20.0_dp,25.0_dp,31.5_dp,40.0_dp,50.0_dp,&
  ! 63.0_dp,80.0_dp,100.0_dp,125.0_dp,160.0_dp,200.0_dp,250.0_dp,315.0_dp,&
  ! 400.0_dp,500.0_dp,630.0_dp,800.0_dp,1000.0_dp,1250.0_dp,1600.0_dp,2000.0_dp,&
  ! 2500.0_dp,3150.0_dp,4000.0_dp,5000.0_dp,6300.0_dp,8000.0_dp,10000.0_dp,&
  ! 12500.0_dp,16000.0_dp,20000.0_dp/)
  ...
  ! AdB = (/-70.4_dp,-63.4_dp,-56.7_dp,-50.5_dp,-44.7_dp,-39.4_dp,-34.6_dp,&
  ! -30.2_dp,-26.2_dp,-22.5_dp,-19.1_dp,-16.1_dp,-13.4_dp,-10.9_dp,-8.6_dp,&
  ! -6.6_dp,-4.8_dp,-3.2_dp,-1.9_dp,-0.8_dp,0.0_dp,0.6_dp,1.0_dp,1.2_dp,1.3_dp,&
  ! 1.2_dp,1.0_dp,0.5_dp,-0.1_dp,-1.1_dp,-2.5_dp,-4.3_dp,-6.6_dp,-9.3_dp/)
...
! f2py -c  --opt=-O2 -m _bpmvawt BPM_VAWT.f90
! python C:\Python27\Scripts\f2py.py -c --opt=-O2 --compiler=mingw32 --fcompiler=gfortran -m _bpmvawt BPM_VAWT.f90
