...
from velocity_optimize_pme_surf import fit
import csv
...
for i in range(np.size(s)):
    spr1d,pow1d,pow2d,pow3d,spr2d,skwd,odrd,scl1d,scl2d,scl3d = fit(s[i],t[i],slength[i],False,comp,4,False)
...
if comp == 'mac':
    fdata = '/Users/ning1/Documents/Flow Lab/VAWTWakeModel/wake_model/data/velodatabase_PME_surf3_1.csv'
elif comp == 'fsl':
    if solrun == 1:
        fdata = '/fslhome/ebtingey/compute/VAWTWakeModel/data/velodatabase_PME_surf1.csv'
    elif solrun == 2:
        fdata = '/fslhome/ebtingey/compute/VAWTWakeModel/data/velodatabase_PME_surf2.csv'
    elif solrun == 3:
        fdata = '/fslhome/ebtingey/compute/VAWTWakeModel/data/velodatabase_PME_surf3.csv'
    elif solrun == 4:
        fdata = '/fslhome/ebtingey/compute/VAWTWakeModel/data/velodatabase_PME_surf4.csv'
    elif solrun == 5:
        fdata = '/fslhome/ebtingey/compute/VAWTWakeModel/data/velodatabase_PME_surf5.csv'
